...
\index{cs110graphics::Window@{cs110graphics::Window}!refresh@{refresh}}
\index{refresh@{refresh}!cs110graphics::Window@{cs110graphics::Window}}
...
Refreshes all objects in the window. All objects are redrawn in depth order. 
\begin{DoxyParams}{Parameters}
